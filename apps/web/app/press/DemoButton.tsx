...
const STYLES = {
  ...
  primary:
    "border-2 border-books bg-books px-6 py-3 font-mono text-ident uppercase tracking-[0.08em] text-stock transition-colors hover:bg-stock hover:text-books",
  ...
  // smallest one on it.
  masthead:
    "border-2 border-books bg-books px-5 py-2.5 font-mono text-ident uppercase tracking-[0.06em] text-stock transition-colors hover:bg-stock hover:text-books",
  compact:
    "border-2 border-books bg-books px-4 py-2 font-mono text-stub uppercase text-stock transition-colors hover:bg-stock hover:text-books",
  // Beside a primary, where a second filled button would fork the eye.
  outline:
    "border-2 border-hairline px-6 py-3 font-mono text-ident uppercase tracking-[0.08em] text-graphite transition-colors hover:border-agreed hover:text-agreed",
  // On the inverted plate the inks swap: bone on black.
  plate:
    "border-2 border-stock bg-stock px-6 py-3 font-mono text-ident uppercase tracking-[0.08em] text-plate transition-colors hover:bg-transparent hover:text-stock",
  // Inside a sentence, where the surrounding type is prose and a button would
  // be a box in the middle of a paragraph.
  link:
    "text-agreed underline decoration-hairline underline-offset-4 transition-colors hover:decoration-agreed",
} as const;
