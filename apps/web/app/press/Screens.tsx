...
export function Screens() {
  return (
    <section id="screens" className="scroll-mt-24 py-14 lg:pl-20">
      <Opener slip={0.72} size="text-opener-tight" className="optical-cap max-w-[24ch]">
      ...
      {/* Plates on the left, the contents page beside them.
          ...
          empty anyway. */}
      <div className="mt-10 grid gap-x-12 gap-y-10 lg:grid-cols-[minmax(0,820px)_minmax(0,1fr)]">
