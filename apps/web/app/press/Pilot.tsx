...
export function Pilot() {
  return (
    <div className="mt-8 grid gap-x-14 gap-y-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
      <div>
        <p className="rag-pretty max-w-[40ch] font-sans text-head-4 text-ink sm:text-head-3">
          Three firms. No charge, and no discount to claim later — there is nothing to buy
          yet.
        </p>
        <p className="rag-pretty mt-6 max-w-[52ch] font-sans text-copy-17 leading-relaxed text-ink-muted">
        ...
        <div className="mt-10 border-t border-hairline pt-5">
          <p className="rag-pretty max-w-[52ch] font-sans text-caption-13 leading-relaxed text-ink-muted">
            <a
              href={MAIL}
      ...
      <div>
        <h3 className="font-mono text-label-12 uppercase text-ink-muted">What a pilot is</h3>
